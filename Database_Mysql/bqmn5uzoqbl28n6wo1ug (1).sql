...
--
-- Host: bqmn5uzoqbl28n6wo1ug-mysql.services.clever-cloud.com:3306
-- Generation Time: Mar 27, 2024 at 09:40 AM
...
INSERT INTO `admin` (`id`, `name`, `lastname`, `permission`, `tel`, `username`, `password`) VALUES
(1, 'Tanachai', 'Hona', 'admin', '0655068518', '123456', '123456'),
(9, 'vvv', 'asd', '', 'z', 'asd', '123456'),
(10, 'qwe', 'qwe', '', 'xz', 'asd', '123456'),
(11, 'ธนชัย', 'โห้นา', 'admin', '0655068518', 'tarmsrch159', '0655068518'),
(12, 'zxc', 'zxc', 'admin', 'asd', 'asd', 'asd'),
(13, '22123', '123', 'admin', '0655068518', '159753', '123456'),
(14, '123', '123', 'admin', '123', '789', '123'),
(15, 'อรพินธุ์', 'เวียงคำ', 'admin', '0884560804', 'Oraphin', '1234567'),
(16, 'อรพินธุ์', 'อรพินธุ์', 'admin', '0884560804', 'อรพินธุ์', '12345'),
(17, 'ชนิดา', 'แก้วเพชร', 'admin', '0886742113', 'Chanida', '123456'),
(18, 'ชนิดา', 'แก้วเพชร', 'admin', '0886742113', 'chanida.k', 'chanida.k1728');
...
--
-- Table structure for table `book_id_value`
--

CREATE TABLE `book_id_value` (
  `id` int(11) NOT NULL,
  `id_values` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

--
-- Dumping data for table `book_id_value`
--

INSERT INTO `book_id_value` (`id`, `id_values`) VALUES
(1, ''),
(9, ''),
(10, ''),
(11, ''),
...
INSERT INTO `course_name` (`id`, `name_th`, `name_en`) VALUES
(1, 'สาขาพนักงานการใช้คอมพิวเตอร์ (ประมวลผลคำ) ระดับ ๑', 'Computer Using (Word Processing Program) Level 1  '),
(2, 'สาขาพนักงานการใช้คอมพิวเตอร์ (ตารางทำการ) ระดับ ๑', 'Computer Using (Speed Sheet) Level 1  ');
...
--
-- Table structure for table `id_value`
--
...
--
-- Dumping data for table `id_value`
--
...
CREATE TABLE `member` (
  ...
  `amphure` varchar(10) NOT NULL,
  `district` varchar(10) NOT NULL,
  `gender` varchar(100) NOT NULL,
  `permission` varchar(100) NOT NULL,
  `receipt` varchar(100) NOT NULL,
  `kn_score` int(10) NOT NULL,
  `profi_score` int(10) NOT NULL,
  `sum_score` int(10) NOT NULL,
  `pass_fail` varchar(100) NOT NULL,
  `profile_img` varchar(100) NOT NULL,
  `reg_day` date DEFAULT NULL,
  `book_id` varchar(100) NOT NULL,
  `line_id` varchar(100) NOT NULL,
  `id_card_Img` varchar(100) NOT NULL,
  `educational_Img` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `member` (`id`, `reg_id`, `id_card`, `course`, `candidate`, `prefix`, `prefixEN`, `name`, `lastname`, `name_en`, `lastname_en`, `nationality`, `birthday`, `tel`, `email`, `address`, `educational`, `branch`, `province`, `amphure`, `district`, `gender`, `permission`, `receipt`, `kn_score`, `profi_score`, `sum_score`, `pass_fail`, `profile_img`, `reg_day`, `book_id`, `line_id`, `id_card_Img`, `educational_Img`) VALUES
(1, 'asd', 'asd', '1', 'asd', 'asd', '', 'asd', 'asd', 'asd', 'asd', 'asd', '2023-10-06', 'asdasd', 'asd', 'asd', 'asd', 'asd', 'asd', 'asdasd', 'asdasd', 'asd', 'ผู้สมัคร', 'asd', 0, 20, 30, '', 'asd', '2023-11-01', 'asd', 'asd', 'asd', 'asd');
...
INSERT INTO `summary_score` (`sum_id`, `reg_id`, `course`, `name`, `lastname`, `kn_score`, `profi_score`, `sum_score`, `pass_fail`) VALUES
(1, '', '123456', '123456', '0', 123456, 123456, 123456, ''),
(2, 'REG_0038', '', '', '0', 40, 60, 100, ''),
(3, 'REG_0038', 'สาขาพนักงานการใช้คอมพิวเตอร์(ตารางทำการ)', 'อรพินธุ์', '0', 20, 60, 100, ''),
(4, 'REG_0038', 'สาขาพนักงานการใช้คอมพิวเตอร์(ตารางทำการ)', 'อรพินธุ์', '0', 20, 60, 80, ''),
(5, 'REG_0038', 'สาขาพนักงานการใช้คอมพิวเตอร์(ตารางทำการ)', 'อรพินธุ์', '0', 10, 60, 80, ''),
(6, 'REG_0038', 'สาขาพนักงานการใช้คอมพิวเตอร์(ตารางทำการ)', 'อรพินธุ์', '0', 10, 60, 70, ''),
(7, 'REG_0037', 'สาขาพนักงานการใช้คอมพิวเตอร์(ตารางทำการ)', 'จุฑาทิพย์', '0', 50, 30, 0, ''),
(8, 'REG_0036', 'สาขาพนักงานการใช้คอมพิวเตอร์(ตารางทำการ)', 'ชานนท์', '0', 30, 10, 0, ''),
(9, 'REG_0036', '', '', '', 50, 20, 70, ''),
(10, 'REG_0037', '', '', '', 10, 20, 30, ''),
(11, 'REG_0037', '', '', '', 15, 20, 35, ''),
(12, 'REG_0036', 'สาขาพนักงานการใช้คอมพิวเตอร์(ตารางทำการ)', 'ชานนท์', 'Chanon', 20, 50, 70, 'pass'),
(13, 'REG_0036', 'สาขาพนักงานการใช้คอมพิวเตอร์(ตารางทำการ)', 'ชานนท์', 'Chanon', 32, 15, 47, 'fail');
...
--
-- Indexes for table `book_id_value`
--
ALTER TABLE `book_id_value`
  ADD PRIMARY KEY (`id`);
...
--
-- Indexes for table `summary_score`
--
ALTER TABLE `summary_score`
...
--
-- AUTO_INCREMENT for table `book_id_value`
--
ALTER TABLE `book_id_value`
...
--
-- AUTO_INCREMENT for table `id_value`
--
ALTER TABLE `id_value`
